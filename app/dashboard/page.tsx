                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                  <div className="space-y-6">
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                      ...
                      providing you with the trusted resources you need to
                      create quality, balanced meals for your dog or cat.
                    </p>
          ...
          <div className="mb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                A powerful recipe generator for veterinarians and dog & cat
                lovers to find the perfect proportions of meat, veggies and more
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              <Card className="bg-white border-2 border-green-100 hover:border-green-300 transition-colors">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Generate tailored nutrition plans based on your pet's
                    specific needs
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white border-2 border-green-100 hover:border-green-300 transition-colors">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Complete and balanced meals with all the vitamins and
                    minerals your pet needs
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white border-2 border-green-100 hover:border-green-300 transition-colors">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Human-quality ingredients that are safe and wholesome for
                    your pet
                  </p>
                </CardContent>
              </Card>
