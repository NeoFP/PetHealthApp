          ...
          <div className="w-full max-w-5xl">
                ...
                <CardContent className="space-y-8">
                  ...
                  <div className="p-6 bg-green-50 rounded-lg border border-green-200">
                    ...
                    <p className="text-green-700 text-base">
                      Our AI will automatically analyze your pet's skin
                      condition using advanced image recognition. Simply upload
                      the image and we'll provide a detailed diagnosis with
                ...
                <CardFooter className="flex-col space-y-6 pt-8">
                  ...
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-100 flex items-start gap-3">
                    ...
                    <div className="text-base text-blue-800">
                      ...
                      <p className="mt-1">
                        Your uploaded images are used solely for disease
                        detection and are not stored permanently. All processing
                        is done securely and images are automatically deleted
                        after analysis.
                      </p>
                    </div>
                  </div>
            ...
            <div className="text-center">
              ...
              <ul className="text-base text-gray-600 space-y-2 max-w-2xl mx-auto">
                ...
                <li>
                  • Remove hair/fur from the area if possible (and safe to do
                  so)
                </li>
                <li>
                  • Take multiple photos from different angles if uncertain
                </li>
              </ul>
            </div>
          </div>
