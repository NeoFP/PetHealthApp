          ...
          <div className="w-full max-w-5xl">
            <div className="mb-8 text-center">
              ...
              <p className="text-lg text-gray-600">
                Identify potential health issues by analyzing your pet's
                symptoms
              </p>
            </div>
            ...
            <div className="mt-8 p-6 border-2 rounded-lg bg-yellow-50 border-yellow-200">
              ...
              <p className="text-amber-800 text-base">
                ...
                your pet is experiencing severe symptoms or you're concerned
                about their health, please consult with a veterinarian
                immediately.
              </p>
            </div>
          </div>
